...
const BuyCredit = () => {
  return (
    <div className="min-h-[80vh] text-center pt-14 mb-10">
      ...
      <h1 className="text-center text-2xl md-text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-pink-500 bg-clip-text text-transparent">Choose the plan that’s right for you</h1>
      <div className="flex flex-wrap justify-center gap-6 text-left">
        {plans.map((item,index)=>(
          <div className="bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all duration-500">
            <img width={30} src={assets.logo_icon} alt="" />
